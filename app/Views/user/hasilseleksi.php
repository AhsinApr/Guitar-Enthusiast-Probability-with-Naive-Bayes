            ...
            <form action="">
                ...
                <table>
                    ...
                    <form action="/user/uji_dataaction">
                        <?php foreach ($contentbased1 as $index => $value) : ?>
                            <tr>
                        ...
                        <?php endforeach; ?>
                        <?php foreach ($contentbased2 as $index => $value) : ?>
                            <tr>
                                <td>
                                    <input style="border: none;" name="nama" type="text" readonly value="<?= $value->nama; ?>">
                                </td>
                ...
                <form style="margin-top: 2%;" action="/user/uji_datanb">
                    <!-- <div class="banner">
                        <h1>Uji Data</h1>
                    </div> -->
                    <div>
                        <h4>Total Data : <?= $contenbased ?></h4>
                        <h4>Class Disukai : <?= $classsuka ?></h4>
                        <h4>Class Tidak Disukai : <?= $classtidakdisukai ?></h4>
                    </div>
                    <input name="totaldata" value="<?= $contenbased ?>" type="hidden">
                    <input name="totalsuka" value="<?= $classsuka ?>" type="hidden">
                    <input name="totaltidak" value="<?= $classtidakdisukai ?>" type="hidden">
                    <input name="jenis" value="<?= $jenis ?> " type="hidden">
                    <input name="ukuran" value="<?= $ukuran ?> " type="hidden">
                    <input name="warna" value="<?= $warna1 ?> " type="hidden">
                    <input name="harga" value="<?= $harga1 ?> " type="hidden">
                    <div class="btn-block">
                        <button type="submit" href="/">Uji Data</button>
                    </div>
                </form>
        </div>
