...
<body>
    ...
    <section class="tampilan">
        ...
        <div class="testbox">
            <form action="/user/savemerk" method="post" enctype="multipart/form-data">
                <div class="banner">
                    <h1>Form Tambah Merk Guitar</h1>
                </div>
                <div class="item">
                    <p>Id Merk Guitar</p>
                    <input type="text" name="id_merk" />
                ...
                <div class="btn-block">
                    <button type="submit" href="/">Tambah Data</button>
                </div>
        </div>
