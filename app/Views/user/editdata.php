            ...
            <form action="/user/carigitar">
                ...
                <div class="item">
                    ...
                    <select name="id_merk">
                        ...
                        <option value="Cetta">Cetta</option>
                ...
                <div class="btn-block">
                    <button type="submit" href="/">Cari Data</button>
                </div>
            </form>
        </div>
                ...
                <table>
                    ...
                    <?php foreach ($gitar as $gitar) : ?>
                        <tr>
                            ...
                            <td><?= $gitar->ukuran; ?></td>
                            <td><?= $gitar->warna; ?></td>
                            <td><img src="/imggitar/<?= $gitar->gambar; ?>"></td>

                            <td>
                                <div>
                                    <a class="btn btn-danger" href="/user/deletedata/<?= $gitar->id_gitar; ?>" role="button" onclick="
                                         return confirm('apakah anda yakin data akan dihapus?');">Hapus</a>
                                    <br />
                                    <br />
                                    <a class="btn btn-warning" href="/user/editgitar/<?= $gitar->id_gitar; ?>" role="button">Edit</a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
